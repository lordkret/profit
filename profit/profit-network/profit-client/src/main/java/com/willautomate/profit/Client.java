...
//			wordSerice.execute(new LuckyWalker(7500+i,NetworkPattern.Elmann,15,30));
...
//			wordSerice.execute(new LuckyWalker(9500+i,NetworkPattern.Elmann,90,100));
			wordSerice.execute(new LuckyWalker(10000+i,NetworkPattern.Elmann,4,142));
			
//			wordSerice.execute(new GrowingWordWalker(100+i,1,NetworkPattern.Elmann,2,30));
//			wordSerice.execute(new GrowingWordWalker(200+i,2,NetworkPattern.Elmann,4,142));
